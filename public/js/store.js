...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/Paginate.vue?vue&type=script&lang=js&":
/*!*************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/babel-loader/lib??ref--5-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/Paginate.vue?vue&type=script&lang=js& ***!
  \*************************************************************************************************************************************************************************************************************/
...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/store/src/Store.vue?vue&type=script&lang=js&":
/*!*********************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/babel-loader/lib??ref--5-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/store/src/Store.vue?vue&type=script&lang=js& ***!
  \*********************************************************************************************************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_Paginate__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../components/Paginate */ "./resources/js/components/Paginate.vue");
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  name: 'Store',
  components: {
    Pagination: _components_Paginate__WEBPACK_IMPORTED_MODULE_0__["default"]
  },
  data: function data() {
    return {
      provinces: [],
  ...
  methods: {
    getStore: function getStore() {
      ...
      baseApi.get('stores').then(function (response) {
    ...
    getProvinsi: function getProvinsi() {
      ...
      baseApi.get('provinces').then(function (response) {
        // console.log(response.data);
        return _this2.provinces = response.data.data;
      }, function (error) {
        console.log(error);
      });
    },
    open: function open(store) {
      this.center = store.position;
    },
    onIdle: function onIdle() {},
    onMapClick: function onMapClick() {},
    setUserPosition: function setUserPosition() {},
    provChange: function provChange(event) {
      var _this3 = this;

      baseApi.get('province/' + this.currentProvince).then(function (response) {
        // console.log(response.data);
    ...
    cityChange: function cityChange() {
      ...
      baseApi.get('stores/' + this.currentCity).then(function (response) {
        console.log(response.data);
        _this4.storeList = response.data.data;
        return _this4.pages = response.data;
      }, function (error) {
        console.log(error);
      });
    },
    ...
    changePage: function changePage(page) {
      ...
      if (this.currentCity != null) {
        baseApi.get('stores/' + this.currentCity + "?page=".concat(page)).then(function (response) {
          console.log(response.data);
          _this5.storeList = response.data.data;
          return _this5.pages = response.data;
        }, function (error) {
          console.log(error);
        });
      } else {
        baseApi.get('stores' + "?page=".concat(page)).then(function (response) {
          console.log(response.data);
          _this5.storeList = response.data.data;
          return _this5.pages = response.data;
        }, function (error) {
...
/***/ "./node_modules/css-loader/index.js?!./node_modules/postcss-loader/src/index.js?!./node_modules/vue-googlemaps/dist/vue-googlemaps.css":
/*!*********************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader??ref--7-1!./node_modules/postcss-loader/src??ref--7-2!./node_modules/vue-googlemaps/dist/vue-googlemaps.css ***!
  \*********************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./node_modules/vue-googlemaps/dist/vue-googlemaps.css":
/*!*************************************************************!*\
  !*** ./node_modules/vue-googlemaps/dist/vue-googlemaps.css ***!
  \*************************************************************/
/*! no static exports found */
...
var content = __webpack_require__(/*! !../../css-loader??ref--7-1!../../postcss-loader/src??ref--7-2!./vue-googlemaps.css */ "./node_modules/css-loader/index.js?!./node_modules/postcss-loader/src/index.js?!./node_modules/vue-googlemaps/dist/vue-googlemaps.css");
...
/***/ "./node_modules/vue-googlemaps/dist/vue-googlemaps.esm.js":
/*!****************************************************************!*\
  !*** ./node_modules/vue-googlemaps/dist/vue-googlemaps.esm.js ***!
  \****************************************************************/
/*! exports provided: Circle, Rectangle, Geocoder, Map, Marker, NearbyPlaces, PlaceDetails, UserPosition, MapElement, Polyline, Polygon, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function(global) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Circle", function() { return Circle; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NearbyPlaces", function() { return NearbyPlaces; });
...
var render = function() {
  ...
  return _c("nav", { staticClass: "d-flex justify-content-center pt-4 pb-5" }, [
          ...
          "a",
          {
            ...
            on: {
              click: function($event) {
                ...
                return _vm.changePage(_vm.data.meta.current_page - 1)
              }
            }
          },
          [
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/store/src/Store.vue?vue&type=template&id=b6e09dcc&":
/*!*******************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/store/src/Store.vue?vue&type=template&id=b6e09dcc& ***!
  \*******************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var render = function() {
  ...
  var _c = _vm._self._c || _h
  return _c("div", [
    _c("section", { staticClass: "section section__store" }, [
      _c("div", { staticClass: "store-wrapper" }, [
        _c("div", { staticClass: "store-wrapper__col-left" }, [
          _c("div", { staticClass: "store-wrapper__selector" }, [
            _c("h1", [
              _vm._v(
                    ...
                    on: {
                      change: [
                        function($event) {
                          ...
                          _vm.currentProvince = $event.target.multiple
                            ? $$selectedVal
                            : $$selectedVal[0]
                        },
                        _vm.provChange
                    ...
                    on: {
                      change: [
                        function($event) {
                          ...
                          _vm.currentCity = $event.target.multiple
                            ? $$selectedVal
                            : $$selectedVal[0]
                        },
                        _vm.cityChange
                ...
                [
                  _vm._l(_vm.storeList, function(store) {
                    return _c(
                      ...
                      {
                        key: store.id,
                        staticClass: "single-store",
                        class: store.position === _vm.center ? "active" : "",
                        on: {
                          click: function($event) {
                            return _vm.open(store)
                          }
                        }
                      },
                      [
                        _c("h2", { staticClass: "single-store__name" }, [
                          _vm._v(
                            "\n                            " +
                              _vm._s(store.name) +
                              "\n                        "
                        ...
                        _vm._v(" "),
                        _c("span", { staticClass: "single-store__address" }, [
                          _vm._v(
                            "\n                           " +
                  ...
                  _c("pagination", {
                    ...
                    on: { paginate: _vm.changePage }
                  })
                ],
                2
              )
            : _c("div", { staticClass: "list-store" }, [_vm._m(0)])
        ]),
        _vm._v(" "),
        _c(
          "div",
          { staticClass: "store-wrapper__col-right" },
          [
            _c(
              "googlemaps-map",
              {
                ...
                on: {
                  ...
                  "update:zoom": function($event) {
                    return _vm.$set(_vm.mapOptions, "zoom", $event)
                  },
                  idle: _vm.onIdle,
              ...
              [
                _c("googlemaps-user-position", {
                  on: { "update:position": _vm.setUserPosition }
                }),
                _vm._v(" "),
                _vm._l(_vm.storeList, function(marker) {
                  return _c("googlemaps-marker", {
                    key: marker._id,
                    attrs: {
                      label: {
                        color:
                          marker.position === _vm.center ? "#34d76e" : "white",
...
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticClass: "blank" }, [
      _c("img", {
        attrs: { src: "/images/store-notfound.png", alt: "Blank Store" }
      }),
      _vm._v(" "),
      _c("h2", [
        _vm._v(
...
var API_ENDPOINT =  true ? 'konilife.devs' : undefined;
var baseApi = axios__WEBPACK_IMPORTED_MODULE_0___default.a.create({
  baseURL: "https://".concat(API_ENDPOINT, "/api/"),
  timeout: 2000
});
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_babel_loader_lib_index_js_ref_5_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Paginate_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/babel-loader/lib??ref--4-0!../../../node_modules/babel-loader/lib??ref--5-0!../../../node_modules/vue-loader/lib??vue-loader-options!./Paginate.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js?!./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/Paginate.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport */ /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_babel_loader_lib_index_js_ref_5_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Paginate_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 
...
/* harmony import */ var vue_googlemaps__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! vue-googlemaps */ "./node_modules/vue-googlemaps/dist/vue-googlemaps.esm.js");
/* harmony import */ var vue_googlemaps_dist_vue_googlemaps_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! vue-googlemaps/dist/vue-googlemaps.css */ "./node_modules/vue-googlemaps/dist/vue-googlemaps.css");
/* harmony import */ var vue_googlemaps_dist_vue_googlemaps_css__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(vue_googlemaps_dist_vue_googlemaps_css__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _src_Store__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./src/Store */ "./resources/js/store/src/Store.vue");
...
window.baseApi = _api__WEBPACK_IMPORTED_MODULE_4__["default"];
vue__WEBPACK_IMPORTED_MODULE_0___default.a.use(vue_googlemaps__WEBPACK_IMPORTED_MODULE_1__["default"], {
  load: {
...
/***/ "./resources/js/store/src/Store.vue":
/*!******************************************!*\
  !*** ./resources/js/store/src/Store.vue ***!
  \******************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Store_vue_vue_type_template_id_b6e09dcc___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Store.vue?vue&type=template&id=b6e09dcc& */ "./resources/js/store/src/Store.vue?vue&type=template&id=b6e09dcc&");
/* harmony import */ var _Store_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Store.vue?vue&type=script&lang=js& */ "./resources/js/store/src/Store.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport *//* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  ...
  _Store_vue_vue_type_template_id_b6e09dcc___WEBPACK_IMPORTED_MODULE_0__["render"],
  _Store_vue_vue_type_template_id_b6e09dcc___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/store/src/Store.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./resources/js/store/src/Store.vue?vue&type=script&lang=js&":
/*!*******************************************************************!*\
  !*** ./resources/js/store/src/Store.vue?vue&type=script&lang=js& ***!
  \*******************************************************************/
/*! exports provided: default */
...
/***/ "./resources/js/store/src/Store.vue?vue&type=template&id=b6e09dcc&":
/*!*************************************************************************!*\
  !*** ./resources/js/store/src/Store.vue?vue&type=template&id=b6e09dcc& ***!
  \*************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Store_vue_vue_type_template_id_b6e09dcc___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../node_modules/vue-loader/lib??vue-loader-options!./Store.vue?vue&type=template&id=b6e09dcc& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/store/src/Store.vue?vue&type=template&id=b6e09dcc&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Store_vue_vue_type_template_id_b6e09dcc___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Store_vue_vue_type_template_id_b6e09dcc___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
...
/***/ 0:
/*!*********************************************************************!*\
  !*** multi ./resources/js/store/index.js ./resources/sass/app.scss ***!
  \*********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! /Users/macbookpro/Project/work/konilife-web-revamp/resources/js/store/index.js */"./resources/js/store/index.js");
module.exports = __webpack_require__(/*! /Users/macbookpro/Project/work/konilife-web-revamp/resources/sass/app.scss */"./resources/sass/app.scss");
