                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-12">
                                        <textarea rows="4" style="max-height: 100px;min-height: 100px"
                                            ...
                                            id="address"
                                            placeholder="Masukkan Alamat Merchant">{{ old('address') }}</textarea>
                                        @error('address')
                                        <div class="invalid-feedback text-right">
                                            {{$message}}
                                        </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-12">
                                        <select class="form-control @error('regencie_id') is-invalid @enderror"
                                            ...
                                            <option selected disabled>Kota Merchant</option>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-12">
                                        <input class="form-control @error('lat') is-invalid @enderror" id="lat"
                                            ...
                                            autocomplete="lat" value="{{ old('lat') }}">
                                        @error('lat')
                                        <div class="invalid-feedback text-right">
                                            {{$message}}
                                        </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-12">
                                        <input class="form-control @error('lng') is-invalid @enderror" id="lng"
                                            ...
                                            autocomplete="lng" value="{{ old('lng') }}">
                                        @error('lng')
                                        <div class="invalid-feedback text-right">
                                            {{$message}}
                                        </div>
