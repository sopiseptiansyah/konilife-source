...
<section class="section section__banner">
    ...
    <div id="homeslider" class="primary-banner" style="width:1280px;height:700px;margin:0 auto;">
        ...
        <div class="ls-slide" data-ls="duration:6000; transition2d:73; kenburnsscale:1.2;">
            <img src="{{asset('images/oxi-left.png')}}" alt="oxi-left" class="ls-layer" style="top:25%; left:-100px; width: 240px"
            ...
            <img src="{{asset('images/anggur-right.png')}}" class="ls-layer" style="top: 50%; left:100.1%; height: 70%"
                ...
                alt="oxi">
            <img src="{{asset('images/oxi.png')}}" class="ls-layer" style="top: 150px; left:115px; width: 480px"
                ...
                alt="oxi">
            <img src="{{asset('images/oxi-font.png')}}" style="top:140px; left:670px; font-weight:600;"
                class="ls-layer"
                ...
                alt="livergard title">
            <p style="font-size:16px; line-height:24px; color:rgba(0, 0, 0, 0.85); top:190px; left:670px; font-weight:600;"
                class="ls-l"
            ...
            <p class="ls-layer"
                ...
                <i class="material-icons"
                    ...
                    Suplemen makanan herbal yang bersifat sebagai antioksidan alami, untuk memelihara kesehatan dan daya tahan tubuh.
            </p>
            ...
            {{-- <a href="https://www.konimexstore.com/produk/detail/kode/KONILIFE+OXI" target="_blank" style="top: 380px; left: 720px;" class="ls-l"
            ...
            <a href="https://shopee.co.id/Konilife-Oxi-Food-Supplement-Botol-30-kaplet-Anti-Oksidan-Alami-i.63334771.1182893756" target="_blank" style="top: 380px; left: 720px;" class="ls-l"
                data-ls="offsetxin:-100%; durationin:1000; delayin:1400; easingin:easeOutQuint;  offsetxout:-100%; durationout:500; clipout:0 0 0 100%; parallaxlevel:0;">
                <img class="ls-l" style="top: 490px; left: 860px;" src={{asset('images/shopee.png')}} alt="Shopee" />
            </a>
            <a href="https://www.tokopedia.com/konimexofficial/konilife-oxi-food-supplement-botol-30-kaplet-anti-oksidan-alami" target="_blank" style="top: 380px; left: 720px;" class="ls-l"
                data-ls="offsetxin:-100%; durationin:1000; delayin:1400; easingin:easeOutQuint;  offsetxout:-100%; durationout:500; clipout:0 0 0 100%; parallaxlevel:0;">
    ...
    {{-- <div id="homeslider-mobile" class="primary-banner" style="width:480px;height:800px;margin:0 auto;">
        <div class="ls-slide" data-ls="duration:6000; transition2d:73; kenburnsscale:1.2;">
            <img src="{{asset('images/oxi-font.png')}}" style="top:80px; left:15px; font-weight:600;"
                class="ls-layer"
                data-ls="offsetxin:-100%; durationin:1000; delayin:400; easingin:easeOutQuint;  offsetxout:-100%; durationout:500; clipout:0 0 0 100%; parallaxlevel:0;">
            ...
            <img src="{{asset('images/oxi.png')}}" class="ls-layer" style="top: 350px; left:50%; width: 360px"
            ...
            <a href="https://www.konimexstore.com/produk/detail/kode/KONILIFE+OXI" target="_blank" style="top: 330px; left: 720px;" class="ls-l"
                data-ls="offsetxin:-100%; durationin:1000; delayin:1400; easingin:easeOutQuint;  offsetxout:-100%; durationout:500; clipout:0 0 0 100%; parallaxlevel:0;">
                <img class="ls-l" style="top: 680px; left: 15px; width:30%" src={{asset('images/konimex.png')}} alt="Konimex" />
            </a>

            <a href="https://shopee.co.id/Konilife-Oxi-Food-Supplement-Botol-30-kaplet-Anti-Oksidan-Alami-i.63334771.1182893756" target="_blank" style="top: 330px; left: 720px;" class="ls-l"
                data-ls="offsetxin:-100%; durationin:1000; delayin:1400; easingin:easeOutQuint;  offsetxout:-100%; durationout:500; clipout:0 0 0 100%; parallaxlevel:0;">
                <img class="ls-l" style="top: 680px; left: 50%; width:30%" src={{asset('images/shopee.png')}} alt="Shopee" />
            </a>
            <a href="https://www.tokopedia.com/konimexofficial/konilife-oxi-food-supplement-botol-30-kaplet-anti-oksidan-alami" target="_blank" style="top: 330px; left: 720px;" class="ls-l"
                data-ls="offsetxin:-100%; durationin:1000; delayin:1400; easingin:easeOutQuint;  offsetxout:-100%; durationout:500; clipout:0 0 0 100%; parallaxlevel:0;">
    ...
    <div class="product-hero mobile">
        <div class="container">
            <img src="{{asset('images/oxi-font.png')}}" />
            <p>Memelihara Kesehatan Tubuh</p>
            <ul class="product-hero__list">
                <li>
                    Suplemen makanan herbal yang bersifat sebagai antioksidan alami, untuk memelihara kesehatan dan daya tahan tubuh.
                </li>
            </ul>
            <img class="product-hero__img" src="{{asset('images/oxi.png')}}" 
                alt="oxi"
            >
            <div class="product-hero__social">
                <h4 class="product-hero__social-title">Tersedia di:</h4>
                <div class="product-hero__social-group">
                    <a href="https://www.konimexstore.com/produk/detail/kode/KONILIFE+OXI" target="_blank" rel="noopener noreferrer">
                        <img src={{asset('images/konimex.png')}} alt="Konimex" />
                    </a>
                    <a href="https://shopee.co.id/Konilife-Oxi-Food-Supplement-Botol-30-kaplet-Anti-Oksidan-Alami-i.63334771.1182893756" target="_blank" rel="noopener noreferrer">
                        <img src={{asset('images/shopee.png')}} alt="shopee" />
                    </a>
                    <a href="https://www.tokopedia.com/konimexofficial/konilife-oxi-food-supplement-botol-30-kaplet-anti-oksidan-alami" target="_blank" rel="noopener noreferrer">
...
<section class="section section__product">
    {{-- <img class="floating-component floating-component__padi" src="{{asset('images/oxi-component.png')}}" style="top: -15%" />
    <img class="floating-component floating-component__padi" src="{{asset('images/oxi-left.png')}}" style="    top: 35%;left: unset; right: -6%; transform: scaleX(-1);" /> --}}
    <img class="floating-element floating-element-1 floating-element__oxi-1" src="{{asset('images/oxi-component.png')}}" />
    <img class="floating-element floating-element-2 floating-element__oxi-2" src="{{asset('images/oxi-floating-2.png')}}" />
    <img class="floating-element floating-element-3 floating-element__oxi-3" src="{{asset('images/oxi-floating-3.png')}}" />
    <div class="container">
                ...
                <div class="col-md-6 col-middle">
                    <div>
                        <h1 class="composition__heading">
                            ...
                            (ekstrak biji anggur) 50 mg
                        </h1>
                        <p class="composition__description">
                            Mempunyai kekuatan anti oksidan alami, dimana efek antioksidan dari grape seed lebih kuat dibandingkan antioksidan lainnya. Efek antioksidan dari Grape Seed 50x lebih kuat dari Vitamin E, 20x lebih kuat di bandingkan Vitamin C. Kandungan Grape Seed Extract dalam kaplet Konilife Oxi setara dengan 8.000 biji anggur.
                        </p>
                    </div>
                </div>
                <div class="col-md-6">
                    <img class="composition__image" src="{{asset('images/grape-extract.png')}}" />
                </div>
            </div>
            <div class="row row-introduction mb-5">
                <div class="col-md-6  col-middle">
                    <div>
                        ...
                        <p class="composition__description">
                            Bermanfaat untuk menjaga dan meningkatkan daya tahan tubuh.
                        </p>
                    </div>
                </div>
                <div class="col-md-6">
                    <img class="composition__image ml-0 mr-auto" src="{{asset('images/vitamin-c-2.png')}}" />
                </div>
            </div>
        </div>
        <div class="how-to-use how-to-use__no-space">
            {{-- <img class="floating-component floating-component__padi-3" src="{{asset('images/grape-bottom.png')}}" style="z-index: 2;left: unset;right: -22%;transform: scaleX(-1); width: 180px" />
            <img class="floating-component floating-component__padi-3" src="{{asset('images/grape-bottom.png')}}" style="z-index: 2; left: -15%;bottom: -75px; width: 180px;" /> --}}
            ...
            <div class="col-md-4 mb-4">
                <div class="card-how-to-use h-100">
                    ...
                    <div class="card-how-to-use__dosis">
                        ...
                        <span>
                            1 Kaplet 3 kali sehari setiap hari
                        </span>
                    </div>
                </div>
            </div>
            <div class="col-md-8">
                <div class="card-how-to-use mb-4">
                    ...
                    <video
                        ...
                        width="640"
                        height="300"
                        poster="{{asset('videos/oxi-video-thumb.png')}}"
                        data-setup="{}"
                    >
                        <source src="{{asset('videos/oxi-result.mp4')}}" type="video/mp4" />
                        <p class="vjs-no-js">
...
<section class="section section__product">
    {{-- <img class="floating-component floating-component__padi-3" src="{{asset('images/oxi-left.png')}}" style="z-index: 2;left: unset;right: 4%;bottom: -7%; transform: scaleX(-1)" /> --}}
    <img class="floating-element floating-element-4 floating-element__oxi-4" src="{{asset('images/oxi-floating-3.png')}}" />
    <div class="container">
        <div class="introduction">
            <div class="introduction__flex">
                <div class="introduction__flex-left">
                    <div class="introduction__flex-wrapper">
                        <img class="introduction__flex-left-img" src="{{asset('images/oxi.png')}}" alt="oxi" />
                        <img src="{{asset('images/oxi-font.png')}}" alt="">
                        <p>
                            Memelihara <br> Kesehatan Tubuh
                        </p>
                    </div>
                </div>
                <div class="introduction__flex-right">
                    ...
                    <div class="store">
                        <a href="https://www.konimexstore.com/produk/detail/kode/KONILIFE+OXI" target="_blank" class="btn btn-store">
                            <img src={{asset('images/konimex.png')}} alt="Konimex" />
                        </a>
                        <a href="https://www.tokopedia.com/konimexofficial/konilife-oxi-food-supplement-botol-30-kaplet-anti-oksidan-alami" target="_blank" class="btn btn-store">
                            <img src={{asset('images/tokopedia.png')}} alt="Tokopedia" />
                        </a>
                        <a href="https://shopee.co.id/Konilife-Oxi-Food-Supplement-Botol-30-kaplet-Anti-Oksidan-Alami-i.63334771.1182893756" target="_blank" class="btn btn-store">
                            <img src={{asset('images/shopee.png')}} alt="Shopee" />
                        </a>
                    </div>
                </div>
            ...
            {{-- <div class="row">
                <div class="col-md-8 p-relative">
                    <img class="introduction__image" src="{{asset('images/oxi.png')}}" alt="oxi" style="max-width: 65%" />
                    <div class="introduction-card">
                        <div class="introduction-card__wrapper">
                            <img src="{{asset('images/oxi-font.png')}}" alt="oxi">
                            <p>
                                Memelihara<br /> Kesehatan Tubuh
                            </p>
                        </div>
