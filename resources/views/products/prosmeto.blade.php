...
<section class="section section__banner">
    ...
    <div id="homeslider" class="primary-banner" style="width:1280px;height:700px;margin:0 auto;">
        ...
        <div class="ls-slide" data-ls="duration:6000; transition2d:73; kenburnsscale:1.2;">
            ...
            <img src="{{asset('images/prosmeto-right.png')}}" class="ls-layer" style="top: 35%; left:103%; height: 50%"
                ...
                alt="Tomato">
            <img src="{{asset('images/prosmeto.png')}}" class="ls-layer" style="top: 150px; left:115px; width: 480px"
                ...
                alt="prosmeto">
            <img src="{{asset('images/prosmeto-font.png')}}" style="top:80px; left:670px; font-weight:600;"
                class="ls-layer"
                ...
                alt="prosmeto title">
            <p style="font-size:16px; line-height:24px; color:rgba(0, 0, 0, 0.85); top:130px; left:670px; font-weight:600;"
                class="ls-l"
            ...
            <p class="ls-layer"
                ...
                Suplemen makanan herbal yang bermanfaat untuk memelihara kesehatan prostat serta mengatasi gejala yang disebabkan karena pembesaran prostat.
            </p>
            <p class="ls-layer"
                ...
                <i class="material-icons"
                    style="position: absolute; left: 0; top: 4px; color: rgba(0, 0, 0, 0.6); font-size: 18px">fiber_manual_record</i>
                    Mengandung Lycopene yang termasuk antioksidan dan ekstrak Saw Palmetto yang terbukti efektif mengatasi masalah kesehatan prostat.
            </p>
            ...
            {{-- <a href="https://www.konimexstore.com/produk/detail/kode/KONILIFE+PROSMETO" target="_blank" style="top: 380px; left: 720px;" class="ls-l"
            ...
            <a href="https://shopee.co.id/Konilife-Prosmeto-Food-Supplement-Botol-30-Kesehatan-Prostat-Halal-i.63334771.1182893529" target="_blank" style="top: 380px; left: 720px;" class="ls-l"
                data-ls="offsetxin:-100%; durationin:1000; delayin:1400; easingin:easeOutQuint;  offsetxout:-100%; durationout:500; clipout:0 0 0 100%; parallaxlevel:0;">
                <img class="ls-l" style="top: 490px; left: 860px;" src={{asset('images/shopee.png')}} alt="Shopee" />
            </a>
            <a href="https://www.tokopedia.com/konimexofficial/konilife-prosmeto-food-supplement-botol-30-kesehatan-prostat-halal" target="_blank" style="top: 380px; left: 720px;" class="ls-l"
                data-ls="offsetxin:-100%; durationin:1000; delayin:1400; easingin:easeOutQuint;  offsetxout:-100%; durationout:500; clipout:0 0 0 100%; parallaxlevel:0;">
    ...
    {{-- <div id="homeslider-mobile" class="primary-banner" style="width:480px;height:800px;margin:0 auto;">
        <div class="ls-slide" data-ls="duration:6000; transition2d:73; kenburnsscale:1.2;">
            <img src="{{asset('images/prosmeto-font.png')}}" style="top:40px; left:15px; font-weight:600;"
                class="ls-layer"
                data-ls="offsetxin:-100%; durationin:1000; delayin:400; easingin:easeOutQuint;  offsetxout:-100%; durationout:500; clipout:0 0 0 100%; parallaxlevel:0;">
            ...
            <img src="{{asset('images/prosmeto.png')}}" class="ls-layer" style="top: 420px; left:50%; width: 360px"
            ...
            <a href="https://www.konimexstore.com/produk/detail/kode/KONILIFE+PROSMETO" target="_blank" style="top: 330px; left: 720px;" class="ls-l"
                data-ls="offsetxin:-100%; durationin:1000; delayin:1400; easingin:easeOutQuint;  offsetxout:-100%; durationout:500; clipout:0 0 0 100%; parallaxlevel:0;">
                <img class="ls-l" style="top: 680px; left: 15px; width:30%" src={{asset('images/konimex.png')}} alt="Konimex" />
            </a>

            <a href="https://shopee.co.id/Konilife-Prosmeto-Food-Supplement-Botol-30-Kesehatan-Prostat-Halal-i.63334771.1182893529" target="_blank" style="top: 330px; left: 720px;" class="ls-l"
                data-ls="offsetxin:-100%; durationin:1000; delayin:1400; easingin:easeOutQuint;  offsetxout:-100%; durationout:500; clipout:0 0 0 100%; parallaxlevel:0;">
                <img class="ls-l" style="top: 680px; left: 50%; width:30%" src={{asset('images/shopee.png')}} alt="Shopee" />
            </a>
            <a href="https://www.tokopedia.com/konimexofficial/konilife-prosmeto-food-supplement-botol-30-kesehatan-prostat-halal" target="_blank" style="top: 330px; left: 720px;" class="ls-l"
                data-ls="offsetxin:-100%; durationin:1000; delayin:1400; easingin:easeOutQuint;  offsetxout:-100%; durationout:500; clipout:0 0 0 100%; parallaxlevel:0;">
    ...
    <div class="product-hero mobile">
        <div class="container">
            <img src="{{asset('images/prosmeto-font.png')}}" />
            <p>Memelihara Kesehatan Prostat</p>
            ...
            <img class="product-hero__img" src="{{asset('images/prosmeto.png')}}" 
                alt="prosmeto"
            >
            <div class="product-hero__social">
                <h4 class="product-hero__social-title">Tersedia di:</h4>
                <div class="product-hero__social-group">
                    <a href="https://www.konimexstore.com/produk/detail/kode/KONILIFE+PROSMETO" target="_blank" rel="noopener noreferrer">
                        <img src={{asset('images/konimex.png')}} alt="Konimex" />
                    </a>
                    <a href="https://shopee.co.id/Konilife-Prosmeto-Food-Supplement-Botol-30-Kesehatan-Prostat-Halal-i.63334771.1182893529" target="_blank" rel="noopener noreferrer">
                        <img src={{asset('images/shopee.png')}} alt="shopee" />
                    </a>
                    <a href="https://www.tokopedia.com/konimexofficial/konilife-prosmeto-food-supplement-botol-30-kesehatan-prostat-halal" target="_blank" rel="noopener noreferrer">
...
<section class="section section__product">
    {{-- <img class="floating-component floating-component__padi" src="{{asset('images/palmeto.png')}}" style="top: -8%; max-width: 360px" /> --}}
    <img class="floating-element floating-element-1 floating-element__prosmeto-1" src="{{asset('images/prosmeto-floating-1.png')}}" />
    <img class="floating-element floating-element-2 floating-element__prosmeto-2" src="{{asset('images/prosmeto-floating-2.png')}}" />
    <img class="floating-element floating-element-3 floating-element__prosmeto-3" src="{{asset('images/prosmeto-floating-3.png')}}" />
    <div class="container">
                ...
                <div class="col-md-4 col-middle">
                    <div>
                        ...
                        <p class="composition__description">
                            Merupakan antioksidan spesifik untuk prostat, menghambat pertumbuhan sel abnormal dan kerusakan DNA, sehingga mencegah pembesaran prostat.
                        </p>
                    </div>
                </div>
                <div class="col-md-8">
                    <img class="composition__image" src="{{asset('images/prosmeto-right.png')}}" />
                </div>
            </div>
            <div class="row row-introduction mb-5">
                <div class="col-md-6  col-middle">
                    <div>
                        <h2 class="composition__heading">
                            Saw palmetto Extract 25 mg
                        </h2>
                        <p class="composition__description">
                            Adalah herbal yang bermanfaat untuk mencegah pembesaran prostat dengan menghambat produksi hormon dihydrotesterone (hormon yang bertanggung jawab pada pembesaran prostat) serta menghambat perubahan testoterone menjadi dihyfrotestosterone. Saw palmetto juga bermanfaat untuk mengatasi keluhan yang ditimbulkan akibat gangguan prosta, seperti: membantu mengatasi gangguan dalam hubungan seksual , mengurangi rasa sakit akibat gangguan prostat membantu mengatasi kerontokan rambut yang disebabkan oleh peningkatan hormon dihydrotestosterone.
                        </p>
                    </div>
                </div>
                <div class="col-md-6">
                    <img class="composition__image" src="{{asset('images/saw-palmetto.png')}}" />
                </div>
            </div>
            <div class="row row-introduction mb-5">
                <div class="col-md-5  col-middle">
                    <div>
                        <h2 class="composition__heading">
                            Vitamin E 100 mg (100IU)
                        </h2>
                        <p class="composition__description">
                            Sebagai antioksidan yang bermanfaat untuk mencegah kanker prostat, membantu meningkatkan produksi sperma pada pria.
                        </p>
                    </div>
                </div>
                <div class="col-md-7">
                    <img class="composition__image" src="{{asset('images/vitamin-e.png')}}" />
                </div>
            </div>
            <div class="row row-introduction mb-5">
                <div class="col-md-5  col-middle">
                    <div>
                        ...
                        <p class="composition__description">
                            Melindungi prostat dari radikal bebas
                        </p>
                    </div>
                </div>
                <div class="col-md-7">
                    <img class="composition__image mr-auto ml-0" src="{{asset('images/selenium.png')}}" />
                </div>
            </div>
        </div>
        <div class="how-to-use how-to-use__no-space">
            {{-- <img class="floating-component floating-component__padi-3" src="{{asset('images/prosmeto-left.png')}}" style="z-index: 2;left: unset;right: -28%;transform: scaleX(-1); width: 360px" />
            <img class="floating-component floating-component__padi-3" src="{{asset('images/prosmeto-left.png')}}" style="z-index: 2; left: -28%; bottom: -25%; width: 360px;" /> --}}
            ...
            <div class="col-md-8">
                <div class="card-how-to-use mb-4">
                    ...
                    <video
                        ...
                        width="640"
                        height="300"
                        poster="{{asset('videos/prosmeto-video-thumb.png')}}"
                        data-setup="{}"
                    >
                        <source src="{{asset('videos/prosmeto-result.mp4')}}" type="video/mp4" />
                        <p class="vjs-no-js">
...
<section class="section section__product">
    <img class="floating-element floating-element-4 floating-element__prosmeto-4" src="{{asset('images/prosmeto-floating-4.png')}}" />
    <div class="container">
        <div class="introduction">
            ...
            <div class="introduction__flex">
                <div class="introduction__flex-left">
                    <div class="introduction__flex-wrapper">
                        <img class="introduction__flex-left-img" src="{{asset('images/prosmeto.png')}}" alt="prosmeto" />
                        <img src="{{asset('images/prosmeto-font.png')}}" alt="">
                        <p>
                            Memelihara <br> Kesehatan Prostat
                        </p>
                    </div>
                </div>
                <div class="introduction__flex-right">
                    ...
                    <div class="store">
                        <a href="https://www.konimexstore.com/produk/detail/kode/KONILIFE+PROSMETO" target="_blank" class="btn btn-store">
                            <img src={{asset('images/konimex.png')}} alt="Konimex" />
                        </a>
                        <a href="https://www.tokopedia.com/konimexofficial/konilife-prosmeto-food-supplement-botol-30-kesehatan-prostat-halal" target="_blank" class="btn btn-store">
                            <img src={{asset('images/tokopedia.png')}} alt="Tokopedia" />
                        </a>
                        <a href="https://shopee.co.id/Konilife-Prosmeto-Food-Supplement-Botol-30-Kesehatan-Prostat-Halal-i.63334771.1182893529" target="_blank" class="btn btn-store">
                            <img src={{asset('images/shopee.png')}} alt="Shopee" />
                        </a>
                    </div>
                </div>
            ...
            {{-- <div class="row">
                <div class="col-md-8 p-relative">
                    <img class="introduction__image" src="{{asset('images/prosmeto.png')}}" alt="prosmeto" style="max-width: 60%" />
                    <div class="introduction-card">
                        <div class="introduction-card__wrapper">
                            <img src="{{asset('images/prosmeto-font.png')}}" alt="prosmeto" >
                            <p>
                                Memelihara<br/> Kesehatan Prostat
                            </p>
                        </div>
