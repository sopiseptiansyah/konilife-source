...
<section class="section section__banner">
    ...
    <div id="homeslider" class="primary-banner" style="width:1280px;height:700px;margin:0 auto;">
        ...
        <div class="ls-slide" data-ls="duration:6000; transition2d:73; kenburnsscale:1.2;">
            <img src="{{asset('images/bayam.png')}}" alt="bayam" class="ls-layer" style="top:100px; left:-100px;"
            ...
            <img src="{{asset('images/big-salad.png')}}" class="ls-layer" style="top: 50%; left:103%; height: 80%"
                ...
                alt="Salad">
            <img src="{{asset('images/vision.png')}}" class="ls-layer" style="top: 150px; left:115px; width: 480px"
                ...
                alt="livergard">
            <img src="{{asset('images/vision-font.png')}}" style="top:120px; left:670px; font-weight:600;"
                class="ls-layer"
            ...
            <p class="ls-layer"
                style="top: 240px; left: 670px; padding-left: 25px; line-height: 24px;color: rgba(0, 0, 0, 0.6); z-index: 999; font-weight: normal; font-size: 16px; width: 320px; white-space: normal; height: auto;"
                ...
                <i class="material-icons"
                    ...
                    Suplemen makanan herbal yang bermanfaat untuk memelihara kesehatan mata dan mencegah AMD (Age-related Macular Degeneration).
            </p>
            <p class="ls-layer"
                style="top: 360px; left: 670px; padding-left: 25px; line-height: 24px; color: rgba(0, 0, 0, 0.6); z-index: 999; font-weight: normal; font-size: 16px; width: 320px; white-space: normal;height: auto;"
                ...
                <i class="material-icons"
                    style="position: absolute; left: 0; top: 4px; color: rgba(0, 0, 0, 0.3); font-size: 18px">fiber_manual_record</i>
                Mengandung antioksidan, Vitamin A dan mineral yang efektif memelihara kesehatan fungsi mata.
            </p>
            ...
            {{-- <a href="https://www.konimexstore.com/produk/detail/kode/KONILIFE+VISION+SOFTCAPSULE" target="_blank" style="top: 380px; left: 720px;" class="ls-l"
            ...
            <a href="https://www.tokopedia.com/konimexofficial/konilife-vision-food-supplement-botol-30-softcap-jaga-kesehatan-mata" target="_blank" style="top: 380px; left: 720px;" class="ls-l"
                data-ls="offsetxin:-100%; durationin:1000; delayin:1400; easingin:easeOutQuint;  offsetxout:-100%; durationout:500; clipout:0 0 0 100%; parallaxlevel:0;">
    ...
    {{-- <div id="homeslider-mobile" class="primary-banner" style="width:480px;height:800px;margin:0 auto;">
        <div class="ls-slide" data-ls="duration:6000; transition2d:73; kenburnsscale:1.2;">
            <img src="{{asset('images/vision-font.png')}}" style="top:40px; left:15px; font-weight:600;"
                class="ls-layer"
                data-ls="offsetxin:-100%; durationin:1000; delayin:400; easingin:easeOutQuint;  offsetxout:-100%; durationout:500; clipout:0 0 0 100%; parallaxlevel:0;">
            ...
            <img src="{{asset('images/vision.png')}}" class="ls-layer" style="top: 390px; left:50%; width: 360px"
            ...
            <a href="https://www.konimexstore.com/produk/detail/kode/KONILIFE+VISION+SOFTCAPSULE" target="_blank" style="top: 330px; left: 720px;" class="ls-l"
                data-ls="offsetxin:-100%; durationin:1000; delayin:1400; easingin:easeOutQuint;  offsetxout:-100%; durationout:500; clipout:0 0 0 100%; parallaxlevel:0;">
            ...
            <a href="https://www.tokopedia.com/konimexofficial/konilife-vision-food-supplement-botol-30-softcap-jaga-kesehatan-mata" target="_blank" style="top: 330px; left: 720px;" class="ls-l"
                data-ls="offsetxin:-100%; durationin:1000; delayin:1400; easingin:easeOutQuint;  offsetxout:-100%; durationout:500; clipout:0 0 0 100%; parallaxlevel:0;">
    ...
    <div class="product-hero mobile">
        <div class="container">
            <img src="{{asset('images/vision-font.png')}}" />
            <p>Membantu memelihara <br> kesehatan mata</p>
            ...
            <img class="product-hero__img" src="{{asset('images/vision.png')}}" 
                alt="vision"
            >
            <div class="product-hero__social">
                <h4 class="product-hero__social-title">Tersedia di:</h4>
                <div class="product-hero__social-group">
                    <a href="https://www.konimexstore.com/produk/detail/kode/KONILIFE+VISION+SOFTCAPSULE" target="_blank" rel="noopener noreferrer">
                    ...
                    <a href="https://www.tokopedia.com/konimexofficial/konilife-vision-food-supplement-botol-30-softcap-jaga-kesehatan-mata" target="_blank" rel="noopener noreferrer">
...
<section class="section section__product">
    <img class="floating-element floating-element-1 floating-element__vision-1" src="{{asset('images/bayam-2.png')}}" />
    <img class="floating-element floating-element-2 floating-element__vision-2" src="{{asset('images/vision-floating-2.png')}}" />
    <img class="floating-element floating-element-3 floating-element__vision-3" src="{{asset('images/vision-floating-3.png')}}" />
    <div class="container">
                ...
                <div class="col-md-6 col-middle">
                    <div>
                        <p class="composition__description">
                            Konilife Vision berfungsi untuk memelihara kesehatan mata Mencegah dan mengurangi gejala AMD (Age-related Macular Degeneration). Mengurangi resiko Katarak. Membantu penglihatan pada penderita katarak ringan.
                        </p>
                    </div>
                </div>
                <div class="col-md-6">
                    <img class="composition__image" src="{{asset('images/vision-img-1.png')}}" />
                </div>
            </div>
            <div class="row row-introduction mb-5">
                <div class="col-md-6  col-middle">
                    <div>
                        <p class="composition__description">
                            Kombinasi Vitamin A, Lutein, dan Zinc adalah kombinasi efektif untuk memelihara kesehatan mata. Dosis 10mg Lutein per softcapsule merupakan dosis yang direkomendasikan oleh para ahli berdasarkan riset terbaru.
                        </p>
                    </div>
                </div>
                <div class="col-md-6">
                    <img class="composition__image" src="{{asset('images/vitamin-a.png')}}" />
                </div>
            </div>
        </div>
        <div class="how-to-use how-to-use__no-space">
            {{-- <img class="floating-component floating-component__padi-3" src="{{asset('images/bayam-2.png')}}" style="z-index: 2;top: -35%; left: unset;right: -28%;" />
            <img class="floating-component floating-component__padi-3" src="{{asset('images/wortel-1.png')}}" style="z-index: 2;top: -35%; left: -28%;" />
            <img class="floating-component floating-component__padi-3" src="{{asset('images/wortel-2.png')}}" style="z-index: 2;top: unset;bottom: -50%;left: -28%;width: 500px;" />
            <img class="floating-component floating-component__padi-3" src="{{asset('images/bayam.png')}}" style="z-index: 2;top: unset;bottom: -50%;left: unset; right: -27%; transform: scaleX(-1)" /> --}}
            ...
            <div class="col-md-4 mb-4">
                <div class="card-how-to-use h-100">
                    ...
                    <div class="card-how-to-use__dosis">
                        ...
                        <span>
                            1 kapsul lunak perhari atau sesuai anjuran dokter
                        </span>
                    </div>
                </div>
            </div>
            <div class="col-md-8">
                <div class="card-how-to-use mb-4">
                    ...
                    <video
                        ...
                        width="640"
                        height="300"
                        poster="{{asset('videos/vision-video-thumb.png')}}"
                        data-setup="{}"
                    >
                        <source src="{{asset('videos/vision-result.mp4')}}" type="video/mp4" />
                        <p class="vjs-no-js">
...
<section class="section section__product">
    <img class="floating-element floating-element-4 floating-element__vision-4" src="{{asset('images/vision-floating-4.png')}}" />
    {{-- <img class="floating-component floating-component__padi-3" src="{{asset('images/wortel-1.png')}}" style="z-index: 2;top: unset;bottom: 0%;left: unset;right: -16%;transform: scale(-1);width: 500px;" />
    <img class="floating-component floating-component__padi-3" src="{{asset('images/bayam.png')}}" style="z-index: 2;top: unset;bottom: -30%;left: -10%;" /> --}}
    <div class="container">
        <div class="introduction">
            <div class="introduction__flex">
                <div class="introduction__flex-left">
                    <div class="introduction__flex-wrapper">
                        <img class="introduction__flex-left-img" src="{{asset('images/vision.png')}}" alt="vision" />
                        <img src="{{asset('images/vision-font.png')}}" alt="">
                        <p>
                            Membantu memelihara <br> kesehatan mata
                        </p>
                    </div>
                ...
                <div class="introduction__flex-right">
                    ...
                    <div class="store">
                        <a href="https://www.konimexstore.com/produk/detail/kode/KONILIFE+VISION+SOFTCAPSULE" target="_blank" class="btn btn-store">
                            <img src={{asset('images/konimex.png')}} alt="Konimex" />
                        </a>
                        <a href="https://www.tokopedia.com/konimexofficial/konilife-vision-food-supplement-botol-30-softcap-jaga-kesehatan-mata" target="_blank" class="btn btn-store">
                            <img src={{asset('images/tokopedia.png')}} alt="Tokopedia" />
                        </a>
                        <a href="https://shopee.co.id/Konilife-Vision-Food-Supplement-Botol-30-softcap-Jaga-Kesehatan-Mata-i.63334771.1182893502" target="_blank" class="btn btn-store">
                            <img src={{asset('images/shopee.png')}} alt="Shopee" />
                        </a>
                    </div>
                </div>
            ...
            {{-- <div class="row">
                <div class="col-md-8 p-relative">
                    <img class="introduction__image" src="{{asset('images/vision.png')}}" alt="vision" style="max-width: 55%" />
                    <div class="introduction-card">
                        <div class="introduction-card__wrapper">
                            <img src="{{asset('images/vision-font.png')}}" alt="vision">
                            <p>
                                Membantu Memelihara <br /> Kesehatan Mata
                            </p>
                        </div>
