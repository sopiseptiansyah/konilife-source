...
<section class="section section__banner">
    ...
    <div id="homeslider" class="primary-banner" style="width:1280px;height:700px;margin:0 auto;">
        ...
        <div class="ls-slide" data-ls="duration:6000; transition2d:73; kenburnsscale:1.2;">
            <img src="{{asset('images/glucotrim-left.png')}}" alt="glucotrim-left" class="ls-layer" style="top:0; left:-100px; width: 280px"
            ...
            <img src="{{asset('images/glucotrim-right.png')}}" class="ls-layer" style="top: 50%; left:103%; height: 80%"
                ...
                alt="Glucotrim">
            <img src="{{asset('images/glucotrim.png')}}" class="ls-layer" style="top: 150px; left:115px; width: 480px"
                ...
                alt="glucotrim">
            <img src="{{asset('images/glucotrim-font.png')}}" style="top:80px; left:670px; font-weight:600;"
                class="ls-layer"
            ...
            <p class="ls-layer"
                style="top: 180px; left: 670px; padding-left: 25px; line-height: 24px;color: rgba(0, 0, 0, 0.6); z-index: 999; font-weight: normal; font-size: 16px; width: 320px; white-space: normal; height: auto;"
            ...
            <p class="ls-layer"
                style="top: 310px; left: 670px; padding-left: 25px; line-height: 24px; color: rgba(0, 0, 0, 0.6); z-index: 999; font-weight: normal; font-size: 16px; width: 320px; white-space: normal;height: auto;"
                ...
                <i class="material-icons"
                    style="position: absolute; left: 0; top: 4px; color: rgba(0, 0, 0, 0.3); font-size: 18px">fiber_manual_record</i>
                    Mengandung White Kidney Bean Extract yang terbukti efektif untuk membantu mengontrol kadar gula dalam darah untuk tetap bugar dan sehat.
            </p>

            <p style="font-size:16px; line-height:24px; color:rgba(0, 0, 0, 0.85); top:460px; left:670px; font-weight:600;"
                class="ls-l"
            ...
            <div class="button__social-group ls-l" style="display:flex !important; top: 500px; left: 670px;">
                <a class="button__social" href="https://www.konimexstore.com/produk/detail/kode/KONILIFE+GLUCOTRIM" target="_blank">
                    <img class="button__social-img" src={{asset('images/konimex.png')}} alt="Konimex" />
                </a>
                <a class="button__social" href="https://shopee.co.id/Konilife-Glucotrim-Food-Supplement-Botol-30-Menjaga-Kadar-Gula-Darah-i.63334771.1182893703" target="_blank">
                    <img class="button__social-img" src={{asset('images/shopee.png')}} alt="Shopee" />
                </a>
                <a class="button__social" href="https://www.tokopedia.com/konimexofficial/konilife-glucotrim-food-supplement-botol-30-menjaga-kadar-gula-darah" target="_blank">
                    <img class="button__social-img" src={{asset('images/tokopedia.png')}} alt="Tokopedia" />
                </a>
            </div>

            {{-- <a href="https://www.konimexstore.com/produk/detail/kode/KONILIFE+GLUCOTRIM" target="_blank" style="top: 380px; left: 720px;" class="ls-l"
            ...
            <a href="https://shopee.co.id/Konilife-Glucotrim-Food-Supplement-Botol-30-Menjaga-Kadar-Gula-Darah-i.63334771.1182893703" target="_blank" style="top: 380px; left: 720px;" class="ls-l"
                data-ls="offsetxin:-100%; durationin:1000; delayin:1400; easingin:easeOutQuint;  offsetxout:-100%; durationout:500; clipout:0 0 0 100%; parallaxlevel:0;">
                <img class="ls-l" style="top: 490px; left: 860px;" src={{asset('images/shopee.png')}} alt="Shopee" />
            </a>
            <a href="https://www.tokopedia.com/konimexofficial/konilife-glucotrim-food-supplement-botol-30-menjaga-kadar-gula-darah" target="_blank" style="top: 380px; left: 720px;" class="ls-l"
                data-ls="offsetxin:-100%; durationin:1000; delayin:1400; easingin:easeOutQuint;  offsetxout:-100%; durationout:500; clipout:0 0 0 100%; parallaxlevel:0;">
    ...
    {{-- <div id="homeslider-mobile" class="primary-banner" style="width:480px;height:800px;margin:0 auto;">
        <div class="ls-slide" data-ls="duration:6000; transition2d:73; kenburnsscale:1.2;">
            <img src="{{asset('images/glucotrim-font.png')}}" style="top:30px; left:15px; font-weight:600;"
                class="ls-layer"
                data-ls="offsetxin:-100%; durationin:1000; delayin:400; easingin:easeOutQuint;  offsetxout:-100%; durationout:500; clipout:0 0 0 100%; parallaxlevel:0;">
            <p style="width: 100%; font-size:24px; line-height:27px; color:rgba(0, 0, 0, 0.85); top:85px; left:15px; font-weight:600;"
                class="ls-l"
                data-ls="offsetxin:-100%; durationin:1000; delayin:600; easingin:easeOutQuint;  offsetxout:-100%; durationout:500; clipout:0 0 0 100%; parallaxlevel:0;">
                Memberi Manfaat<br/> Bagi Penderita Diabetes
            </p>
            <p class="ls-layer"
            ...
            <p class="ls-layer"
                style="top: 290px; left: 15px; padding-left: 25px; line-height: 24px; color: rgba(0, 0, 0, 0.6); z-index: 999; font-weight: normal; font-size: 16px; width: 320px; white-space: normal;height: auto;"
                data-ls="offsetxin:-240px; durationin:1200; delayin:1000; easingin:easeOutQuint;  offsetxout:-100%; durationout:500; clipout:0 0 0 100%; parallaxlevel:0;">
                <i class="material-icons"
                    style="position: absolute; left: 0; top: 4px; color: rgba(0, 0, 0, 0.6); font-size: 18px">fiber_manual_record</i>
                    Mengandung White Kidney Bean Extract yang terbukti efektif untuk membantu mengontrol kadar gula dalam darah untuk tetap bugar dan sehat.
            </p>
            <img src="{{asset('images/glucotrim.png')}}" class="ls-layer" style="top: 420px; left:50%; width: 360px"
            ...
            <a href="https://www.konimexstore.com/produk/detail/kode/KONILIFE+GLUCOTRIM" target="_blank" style="top: 330px; left: 720px;" class="ls-l"
                data-ls="offsetxin:-100%; durationin:1000; delayin:1400; easingin:easeOutQuint;  offsetxout:-100%; durationout:500; clipout:0 0 0 100%; parallaxlevel:0;">
                <img class="ls-l" style="top: 680px; left: 15px; width:30%" src={{asset('images/konimex.png')}} alt="Konimex" />
            </a>

            <a href="https://shopee.co.id/Konilife-Glucotrim-Food-Supplement-Botol-30-Menjaga-Kadar-Gula-Darah-i.63334771.1182893703" target="_blank" style="top: 330px; left: 720px;" class="ls-l"
                data-ls="offsetxin:-100%; durationin:1000; delayin:1400; easingin:easeOutQuint;  offsetxout:-100%; durationout:500; clipout:0 0 0 100%; parallaxlevel:0;">
                <img class="ls-l" style="top: 680px; left: 50%; width:30%" src={{asset('images/shopee.png')}} alt="Shopee" />
            </a>
            <a href="https://www.tokopedia.com/konimexofficial/konilife-glucotrim-food-supplement-botol-30-menjaga-kadar-gula-darah" target="_blank" style="top: 330px; left: 720px;" class="ls-l"
                data-ls="offsetxin:-100%; durationin:1000; delayin:1400; easingin:easeOutQuint;  offsetxout:-100%; durationout:500; clipout:0 0 0 100%; parallaxlevel:0;">
    ...
    <div class="product-hero mobile">
        <div class="container">
            <img src="{{asset('images/glucotrim-font.png')}}" />
            <p>Memberi Manfaat Bagi Penderita Diabetes</p>
            ...
            <img class="product-hero__img" src="{{asset('images/glucotrim.png')}}" 
                alt="glucotrim"
            >
            <div class="product-hero__social">
                <h4 class="product-hero__social-title">Tersedia di:</h4>
                <div class="product-hero__social-group">
                    <a href="https://www.konimexstore.com/produk/detail/kode/KONILIFE+GLUCOTRIM" target="_blank" rel="noopener noreferrer">
                        <img src={{asset('images/konimex.png')}} alt="Konimex" />
                    </a>
                    <a href="https://shopee.co.id/Konilife-Glucotrim-Food-Supplement-Botol-30-Menjaga-Kadar-Gula-Darah-i.63334771.1182893703" target="_blank" rel="noopener noreferrer">
                        <img src={{asset('images/shopee.png')}} alt="shopee" />
                    </a>
                    <a href="https://www.tokopedia.com/konimexofficial/konilife-glucotrim-food-supplement-botol-30-menjaga-kadar-gula-darah" target="_blank" rel="noopener noreferrer">
...
<section class="section section__product">
    {{-- <img class="floating-component floating-component__padi" src="{{asset('images/glucotrim-component.png')}}" style="top: -8%" /> --}}
    <img class="floating-element floating-element-1 floating-element__glucotrim-1" src="{{asset('images/glucotrim-component.png')}}" />
    <img class="floating-element floating-element-2 floating-element__glucotrim-2" src="{{asset('images/glucotrim-floating-2.png')}}" />
    <img class="floating-element floating-element-3 floating-element__glucotrim-3" src="{{asset('images/glucotrim-floating-3.png')}}" />
    <div class="container">
        <div class="composition composition-full-height">
            <div class="row row-introduction mb-5">
                <div class="col-md-7 col-middle">
                    <div>
                        <h1 class="composition__heading">
                            Phaseolus vulgaris extract (white kidney bean extract) 250 mg
                        </h1>
                ...
                <div class="col-md-5">
                    <img class="composition__image" src="{{asset('images/phaseolus.png')}}" />
                </div>
            </div>
            <div class="row row-introduction mb-5">
                <div class="col-md-6  col-middle">
                    <div>
                        ...
                        <p class="composition__description">
                            proses penyerapan chromium dalam bentuk chromium picolinate lebih mudah diserap oleh tubuh. Bekerja sangat efektif untuk merangsang tubuh bekerja optimal memproduksi insulin, sehingga membantu menurunkan kadar gula darah pada penderita diabetes. Berperan penting pada metabolisme dan penggunaan karbohidrat, sintesa asam lemak, kolesterol dan protein.
                        </p>
                    </div>
                </div>
                <div class="col-md-6">
                    <img class="composition__image ml-0 mr-auto" src="{{asset('images/chromium.png')}}" />
                </div>
            </div>
        </div>
        <div class="how-to-use how-to-use__no-space">
            {{-- <img class="floating-component floating-component__padi-3" src="{{asset('images/glucotrim-left.png')}}" style="z-index: 2;left: unset;right: -25%;transform: scaleX(-1);" />
            <img class="floating-component floating-component__padi-3" src="{{asset('images/glucotrim-bottom.png')}}" style="z-index: 2; left: -15%;bottom: -75px;" /> --}}
            ...
            <div class="col-md-8">
                <div class="card-how-to-use mb-4">
                    ...
                    <video
                        ...
                        width="640"
                        height="300"
                        poster="{{asset('videos/glucotrim-video-thumb.png')}}"
                        data-setup="{}"
                    >
                        <source src="{{asset('videos/glucotrim-result.mp4')}}" type="video/mp4" />
                        <p class="vjs-no-js">
...
<section class="section section__product">
    {{-- <img class="floating-component floating-component__padi-3" src="{{asset('images/glucotrim-bottom.png')}}" style="z-index: 2;left: unset;right: 4%;bottom: -7%;transform: scaleX(-1);" /> --}}
    <img class="floating-element floating-element-4 floating-element__glucotrim-4" src="{{asset('images/glucotrim-floating-2.png')}}" />
    <div class="container">
        <div class="introduction">
            <div class="introduction__flex">
                <div class="introduction__flex-left">
                    <div class="introduction__flex-wrapper">
                        <img class="introduction__flex-left-img" src="{{asset('images/glucotrim.png')}}" alt="glucotrim" />
                        <img src="{{asset('images/glucotrim-font.png')}}" alt="">
                        <p>
                            Memberi manfaat <br> bagi penderita diabetes
                        </p>
                    </div>
                ...
                <div class="introduction__flex-right">
                    ...
                    <div class="store">
                        <a href="https://www.konimexstore.com/produk/detail/kode/KONILIFE+GLUCOTRIM" target="_blank" class="btn btn-store">
                            <img src={{asset('images/konimex.png')}} alt="Konimex" />
                        </a>
                        <a href="https://www.tokopedia.com/konimexofficial/konilife-glucotrim-food-supplement-botol-30-menjaga-kadar-gula-darah" target="_blank" class="btn btn-store">
                            <img src={{asset('images/tokopedia.png')}} alt="Tokopedia" />
                        </a>
                        <a href="https://shopee.co.id/Konilife-Glucotrim-Food-Supplement-Botol-30-Menjaga-Kadar-Gula-Darah-i.63334771.1182893703" target="_blank" class="btn btn-store">
                            <img src={{asset('images/shopee.png')}} alt="Shopee" />
                        </a>
                    </div>
                </div>
            ...
            {{-- <div class="row">
                <div class="col-md-8 p-relative">
                    <img class="introduction__image" src="{{asset('images/glucotrim.png')}}" alt="glucotrim" style="    max-width: 55%;" />
                    <div class="introduction-card">
                        <div class="introduction-card__wrapper">
                            <img src="{{asset('images/glucotrim-font.png')}}" alt="glucotrim">
                            <p>
                                Memberi Manfaat<br/> Bagi Penderita Diabetes
                            </p>
                        </div>
