...
<section class="section section__banner">
    ...
    <div id="homeslider" class="primary-banner" style="width:1280px;height:700px;margin:0 auto;">
        ...
        <div class="ls-slide" data-ls="duration:6000; transition2d:73; kenburnsscale:1.2;">
            <img src="{{asset('images/normovas-left.png')}}" class="ls-layer" style="top:0; left:-100px; width: 300px"
            ...
            <img src="{{asset('images/normovas-right.png')}}" class="ls-layer" style="top: 50%; left:103%; height: 80%"
            ...
            <img src="{{asset('images/normovas.png')}}" class="ls-layer" style="top: 150px; left:115px; width: 480px"
            ...
            <img src="{{asset('images/normovas-font.png')}}" style="top:120px; left:670px; font-weight:600;"
                class="ls-layer"
            ...
            <p style="font-size:16px; line-height:24px; color:rgba(0, 0, 0, 0.85); top:170px; left:670px; font-weight:600;"
                ...
                Secara Tradisional Membantu Meringankan <br> Tekanan Darah Tinggi yang Ringan
            </p>
            <ul class="ls-layer product-hero__list"
                style="top: 230px; left: 670px; padding-left: 0; line-height: 24px;color: rgba(0, 0, 0, 0.6); z-index: 999; font-weight: normal; font-size: 16px; width: 400px; white-space: normal; height: auto;"
                ...
                <li>
                    ...
                    dengan mekanisme relaksasi otot pembuluh
                    darah dan diuretik                    
                </li>
            </ul>
            {{-- <p class="ls-layer"
    ...
    <div class="product-hero mobile">
        <div class="container">
            <img src="{{asset('images/normovas-font.png')}}" />
            <p>
            ...
            <img class="product-hero__img" src="{{asset('images/normovas.png')}}" 
                alt="normovas"
            >
...
<section class="section section__product">
    <img class="floating-element floating-element-1 floating-element__normovas-1" src="{{asset('images/normovas-floating-1.png')}}" />
    <img class="floating-element floating-element-2 floating-element__normovas-2" src="{{asset('images/normovas-left.png')}}" />
    <img class="floating-element floating-element-3 floating-element__normovas-3" src="{{asset('images/normovas-floating-1.png')}}" />
    <div class="container">
        <div class="composition composition-full-height">
            <div class="row row-introduction mb-5">
                <div class="col-md-5">
                    <h1 class="composition__heading">
                        Apium Graveolens Herba <br> (Daun Seledri)
                    </h1>
                    <p class="composition__description">
                        Seledri mengandung berbagai kandungan bermanfaat, seperti vitamin (A, B dan C) serta apigenin. Apigenin
                        ( golongan flavonoid ) yang terkandung dalam seledri bersifat vasodilator atau melebarkan pembuluh darah dengan cara menghambat masuknya kalsium ke dalam otot.
                    </p>
                </div>
                <div class="col-md-7">
                    <img class="composition__image" src="{{asset('images/normovas-content-1.png')}}" />
                </div>
            </div>
            <div class="row row-introduction mb-5">
                <div class="col-md-5">
                    <h1 class="composition__heading">
                        Hibiscus Sabdariffa Floz <br> (Bunga Rosella)
                    </h1>
                    <p class="composition__description">
                        Rosella mengandung berbagai vitamin (A, B1, B2, B3, dan C), kalsium, zat besi, magnesium, fosfor, kalium (potasium), dan natrium (sodium). Rosella bekerja seperti ACE inhibitor (captopril, ramipril, dll) untuk merelaksasi
                        pembuluh darah sehingga menurunkan tekanan darah
                    </p>
                </div>
                <div class="col-md-7">
                    <img class="composition__image" src="{{asset('images/normovas-content-2.png')}}" />
                </div>
            </div>
            <div class="row row-introduction mb-5">
                <div class="col-md-5">
                    <h1 class="composition__heading">
                        Imperatae Rhizoma <br> (Alang – Alang)
                    </h1>
                    <p class="composition__description">
                        Alang-alang mengandung Flavonoid, graminone-b
                        dan cylindrene yg berkhasiat untuk mengobati berbagai penyakit termasuk Hypertensi. Alang – alang berfungsi sebagai diuretik (HCT, dkk) yang dapat menurunkan tekanan darah dengan cara menurunkan volume cairan dan membantu membuang natrium dari tubuh.
                    </p>
                </div>
                <div class="col-md-7">
                    <img class="composition__image" src="{{asset('images/normovas-content-3.png')}}" />
                </div>
            </div>
        </div>
            ...
            <div class="introduction__flex">
                <div class="introduction__flex-left">
                    <div class="introduction__flex-wrapper">
                        <img class="introduction__flex-left-img" src="{{asset('images/normovas.png')}}" alt="normovas" />
                        <img src="{{asset('images/normovas-font.png')}}" alt="">
                        <p>
                            Secara Tradisional <br> Membantu Meringankan <br> Tekanan Darah Tinggi <br> <span style="text-transform: lowercase">yang</span> Ringan
                        </p>
                    </div>
                </div>
